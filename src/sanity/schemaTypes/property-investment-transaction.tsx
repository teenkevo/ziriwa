...
export const propertyInvestmentTransaction = defineType({
  name: 'propertyInvestmentTransaction',
  title: 'Property Investment Transaction',
  type: 'document',
  description: 'Purchase, sale, and related transactions for land and property',
  fields: [
    defineField({
      name: 'investment',
      title: 'Investment',
