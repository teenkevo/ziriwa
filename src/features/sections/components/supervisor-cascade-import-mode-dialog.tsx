...
export type CascadeImportModeChoice = 'as-is' | 'ai'

interface SupervisorCascadeImportModeDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  importableCount: number
  aiEnabled: boolean
  selectedMode: CascadeImportModeChoice | null
  onSelectMode: (mode: CascadeImportModeChoice) => void
...
export function SupervisorCascadeImportModeDialog({
  open,
  onOpenChange,
  importableCount,
  aiEnabled,
  ...
  onBack,
  onFinish,
}: SupervisorCascadeImportModeDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-lg'>
        <DialogHeader>
          ...
          <DialogDescription>
            Choose how these manager items should appear on your supervisor
            contract, then select Finish.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div className='space-y-1'>
                ...
                <p className='text-sm text-muted-foreground'>
                  Copy manager wording directly using the standard cascade
                  mapping.
                </p>
              </div>
            </div>
